...
export default function PhoneticQuizPage() {
  ...
  useEffect(() => {
    ...
    // Initialize quiz with phonetic questions
    const quizQuestions = shuffleArray(getQuestionsByCategory('phonetic'));
          ...
          <Card padding="lg" className="w-full max-w-md text-center">
            <CardContent>
              ...
              <h2 className="text-2xl font-semibold text-gray-900 mb-2">
                Phonetic Quiz Complete!
              </h2>
              
              <p className="text-gray-600 mb-6">
                You scored {score}% on the phonetic alphabet quiz
              </p>
    ...
    <Layout showNavigation={false}>
      <div className="min-h-screen flex items-center justify-center">
        <QuizCard
          ...
          onAudioPlay={() => {
            console.log('Playing audio for phonetic question:', currentQuestion.id);
          }}
          onExit={handleExit}
        />
